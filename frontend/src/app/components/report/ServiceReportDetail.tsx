...
import { Box, Typography, Paper, Grid, Divider, List, ListItem, ListItemText, ImageList, ImageListItem } from '@mui/material';
        ...
        {report.imagePaths && report.imagePaths.length > 0 ? (
          <ImageList sx={{ width: '100%', height: 'auto', mt: 2 }} cols={3} rowHeight={164}>
            {report.imagePaths.map((item, index) => (
              // Ensure 'item' is a string before passing to combineImageUrl
              typeof item === 'string' && (
