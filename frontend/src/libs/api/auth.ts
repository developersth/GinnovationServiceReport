...
import { API_BASE_URL } from '../../utils' // Ensure this path is correct based on your project structure
...
export const login = async (username: string, password: string): Promise<boolean> => {
  try {
    ...
    if (!response.ok) {
      ...
      throw new Error(errorData.message || 'ชื่อผู้ใช้งานหรือรหัสผ่านไม่ถูกต้อง')
    }
