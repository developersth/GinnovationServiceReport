  ...
  return (
    <Box>
      ...
      {loading ? (
        ...
        <ProjectTable projects={projects} onEdit={handleEditProject} onDelete={handleDeleteProject} />
      )}

      {/* Form Modal for Add/Edit */}
      <Dialog open={openFormModal} onClose={handleCloseFormModal}>
        <DialogContent>
          <ProjectForm initialData={editingProject} onSubmit={handleFormSubmit} onCancel={handleCloseFormModal} />
        </DialogContent>
      </Dialog>
