...
import { getServiceReportById, getProjects } from '@/libs/api/data'
import { getName } from '@/libs/api/auth' // Import the getName function
...
export default function SingleReportPage() {
  ...
  return (
    <div className='p-4 bg-gray-100 min-h-screen font-sans'>
      <div className='max-w-4xl mx-auto bg-white shadow-lg p-6 md:p-8 border border-gray-300 print-report-container'>
        {' '}
        {/* Added print-report-container class */}
        ...
        <div className='flex justify-between items-center border-b border-gray-300 pb-4 mb-6'>
          <div className='flex items-center'>
            <img src='/images/logos/logo-g.png' alt='G Innovation Logo' className='h-12 w-auto mr-4 object-contain' />
        ...
        <div className='mb-6 grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 text-sm'>
          ...
          <div className='border border-black'>
            ...
            <div className='grid grid-cols-3 min-h-[60px] items-center'>
              ...
              <div className='col-span-2 p-1.5'></div>
            </div>
          </div>
        </div>
        ...
        <div className='text-center text-xs text-gray-600 mt-8 border-t pt-4'>
          ...
          <p>
            ...
            {displayReport.companyFaxFooter
              ? `Fax : ${displayReport.companyFaxFooter}`
              : defaultCompanyFax
                ? `Fax : ${defaultCompanyFax}`
                : ''}
          </p>
