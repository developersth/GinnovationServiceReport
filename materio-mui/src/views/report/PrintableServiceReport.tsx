...
import { getName } from '../../libs/api/auth' // Adjust path if needed
    ...
    >
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          <img
            src='/images/logos/logo-g.png' // Direct local image path
          ...
          <TableBody>
            {reports.map(reportItem => (
              <TableRow key={reportItem.id}>
                ...
                <TableCell sx={{ wordBreak: 'break-word', whiteSpace: 'pre-wrap', fontSize: '0.75rem' }}>
                  {reportItem.complain}
                </TableCell>
                <TableCell sx={{ wordBreak: 'break-word', whiteSpace: 'pre-wrap', fontSize: '0.75rem' }}>
